...
// document.getElementById("btnCriarMapa").addEventListener("click", async () => {
...
//     // Validando os dados
//     if (vagasMotos < 1 || vagasCarros < 1 || vagasMicro < 1) {
//       alert("Todos os campos devem conter valores maiores que 0.");
//       return;
//     }
...
//       const response = await axios.post("/api/vagas/configurar", payload);
...
//       alert("Erro ao salvar as configurações. Tente novamente mais tarde.");
//     }
//   });
